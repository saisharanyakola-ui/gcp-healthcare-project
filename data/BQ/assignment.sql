...
CREATE TABLE IF NOT EXISTS `project-00e61840-f4f1-4e1d-ac8.gold_dataset.financial_metrics` AS
SELECT 
...
-- 5. Payor Performance & Claims Summary (Gold):
-- This table tracks the performance of insurance payors, focusing on claim approval rates, payout amounts, and processing efficiency.

CREATE TABLE IF NOT EXISTS `project-00e61840-f4f1-4e1d-ac8.gold_dataset.payor_performance` AS
SELECT 
    c.PayorID,
    c.PayorType,
    COUNT(DISTINCT c.Claim_Key) AS TotalClaims,
...
FROM `project-00e61840-f4f1-4e1d-ac8.silver_dataset.claims` c
